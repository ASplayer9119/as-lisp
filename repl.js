...
const repl = () => {
  console.log('as-lisp');
  console.log('simple LISP written in JavaScript)');
  console.log('==================================');
  console.log('type "exit" to quit');
  console.log('type "load <filename>" to load a file');
  console.log('-------------------------------------');
  loadFile('./library/standard-library.alisp');
...
const loadFile = filename => {
  try {
    const s = fs.readFileSync(filename, { encoding: 'utf-8' });
    if (!s) {
